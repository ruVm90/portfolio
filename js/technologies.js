document.addEventListener("DOMContentLoaded", () => {
  ...
  technologies.forEach((technology) => {
    ...
    technology_card.className = `
      ...
      w-32 h-32 sm:w-44 sm:h-44 flex flex-col items-center 
    ...
    imgContainer.className = "w-20 h-20 sm:w-28 sm:h-28 flex items-center justify-center mb-2 overflow-hidden";
    ...
    title.className = "text-center text-xs sm:text-sm font-semibold mt-auto";
